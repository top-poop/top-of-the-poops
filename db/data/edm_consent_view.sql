...
drop view if exists consents_unique_view;
/*
...
select edm.reporting_year, edm.company_name, site_name, consent_id, activity_reference, shellfishery, bathing, total_spill_hours, spill_count, reporting_pct, excuses,
