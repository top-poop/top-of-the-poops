select reporting_year, edm.company_name, 'unmatched' as type, coalesce(sum(spill_count),0) as count from edm
...
union all
select reporting_year, company_name, 'matched' as type, coalesce(sum(spill_count),0) as count
